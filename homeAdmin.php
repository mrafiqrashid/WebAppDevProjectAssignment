  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="updateUser.php?userid=<?php echo $userid?>">Update Profile</a></li>      </ul>
...
<div class="container-fluid bg-3 text-center">    
  ...
  <div class="row">
    <div class="col-sm-4">
    <a class="btn btn-primary btn-lg" href="viewQuestion1.php" role="button">Manage Question</a>
    </div>
    <div class="col-sm-4"> 
    <a class="btn btn-primary btn-lg" href="viewInfo.php" role="button">Manage Information</a>
    </div>
