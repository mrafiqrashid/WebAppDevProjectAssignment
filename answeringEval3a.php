...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   // echo $_POST["count"];
    ...
    $sql = "UPDATE score SET score3=:score2 WHERE projectid=:projectid";
    ...
    if ($stmt = $pdo->prepare($sql)) {
        ...
        //    answeringEval1a.php?projectid=23455;
            header("location: answeringEval4a.php?projectid=$projectid");
            exit();
...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left" >Questions Section 3</h2>
    </br>
    ...
    <h5 class="pull-right"><?php echo "Project ID: <small>" . $_GET['projectid'] . "</small>"; ?></h5>
               ...
               //  echo "projectid".$_GET['projectid'];
                    ...
                    $sql = "select questionid, question, rating, no from question where cid = 3 order by no";
...
//echo "projectid".$_GET['projectid'];
              ...
              //      echo '<a type="submit" class="btn btn-primary ml-2" href="answeringEval2a.php?projectid=' . $projectid . '" class="mr-3" title="Evaluate Project" data-toggle="tooltip">Next</a>'; ?>
                    ...
                    <?php
                 //   echo "projectid".$_GET['projectid'];
                    echo '<a class="btn btn-primary" href="answeringEval2a.php?projectid=' . $_GET['projectid'] . '" role="button">Back</a>';
