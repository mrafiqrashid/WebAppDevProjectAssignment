            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left" >Questions Details</h2>
                    ...
                    <div class="mt-3 mb-3 clearfix">
                        ...
                        <a href="addQuestion.php" class="btn btn-success pull-right mr-1"><i class="fa fa-plus"></i> Add New Question</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    $sql = "select question.questionid, question.question, question.rating, criteria.section, question.no from question join criteria on question.cid = criteria.cid order by question.no";
